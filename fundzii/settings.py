"""
Django settings for fundzii project.
...
SECRET_KEY = 'django-insecure-r^i+desnozk^iq@7ynzf)ekd7o&tdi7ntz1%b2rl^!r7qj^i-5'
...
# OTP toggle. Temporarily set to False to disable OTP verification: users log
